...
class TestPriorityScheduling(unittest.TestCase):
    def test_ps_orders_by_higher_priority(self) -> None:
        processes = [
            Process(id="P1", name="A", arrival_time=0, burst_time=7, priority=4),
            Process(id="P2", name="B", arrival_time=0, burst_time=2, priority=9),
    ...
    def test_ps_uses_secondary_tie_breakers(self) -> None:
        processes = [
            Process(id="P1", name="A", arrival_time=0, burst_time=4, priority=8),
            Process(id="P2", name="B", arrival_time=0, burst_time=2, priority=8),
            Process(id="P3", name="C", arrival_time=1, burst_time=1, priority=8),
        ]
